...
<p class="error">
	...
	<?php echo sprintf(__('%s requires a database connection'), $model); ?>
</p>
<p class="error">
	<strong><?php __('Error', false); ?>: </strong>
...
<p class="notice">
	...
	<?php echo sprintf(__('If you want to customize this error message, create %s.'), APP_DIR . DS . 'views' . DS . 'errors' . DS . basename(__FILE__)); ?>
</p>